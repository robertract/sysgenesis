 ...
 * @author Tiago
 */
public class GUIBanco extends javax.swing.JInternalFrame {
...
////        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            if ((guialtera == null) || (!guialtera.isVisible())) {
                ...
                guialtera = new GUIAlteraBanco(tmBanco.getLista().get(linhaSeleciona), this);
    ...
    private GUIAlteraBanco guialtera;
