 ...
 * @author rober
 */
public class GUIPesquisaMembrosCelula extends javax.swing.JDialog {
    ...
    public GUIPesquisaMembrosCelula(JInternalFrame jInternalFrame, String txt) throws Exception {
        initComponents();
    ...
    private void selecionar() {
        ...
        GUIAdicionarMembrosCelula c = (GUIAdicionarMembrosCelula) principal;
        Membro membro = null;
        membro = this.getMembro();
        c.membroSelecionado = membro;
        c.setarMembro(membro);
        this.dispose();
