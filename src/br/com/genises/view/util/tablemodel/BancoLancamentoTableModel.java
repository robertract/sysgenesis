 ...
 * @author Tiago
 */
public class BancoLancamentoTableModel extends AbstractTableModel {

    private List<LancamentoBanco> lista;
    ...
    public BancoLancamentoTableModel(List<String> campos) {
        lista = new ArrayList<>();
        this.listaCampos = campos;
    }

    public void adiciona(LancamentoBanco object) {
        lista.add(object);
        int ultimoIndice = getRowCount() - 1;
        fireTableRowsInserted(ultimoIndice, ultimoIndice);
    }

    public void adicionaList(List<LancamentoBanco> objects) {
        this.lista = objects;
        int ultimoIndice = getRowCount() - 1;
        fireTableRowsInserted(ultimoIndice, ultimoIndice);
    }
...
//        }
    ...
    public List<LancamentoBanco> getLista() {
        return lista;
    }

    public void setLista(List<LancamentoBanco> lista) {
        this.lista = lista;
    }
